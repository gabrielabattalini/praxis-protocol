...
export const financeCategorySeed: FinanceCategory[] = [
  ...
  { id: "finance-category-expense-home-bills", name: "Contas da casa", kind: "expense", icon: "\u{1F4A1}" },
  ...
  { id: "finance-category-expense-health", name: "Saúde", kind: "expense", icon: "\u{1FA7A}" },
  { id: "finance-category-expense-beauty", name: "Beleza", kind: "expense", icon: "\u2728" },
  ...
  { id: "finance-category-expense-communication", name: "Comunicação", kind: "expense", icon: "\u{1F4F6}" },
...
export const mealPlanSeed: MealPlanBlock[] = [
  {
    ...
    notes: "Suplementos de jejum antes do cardio.",
  },
  {
    id: "meal-breakfast",
    title: "Café da manhã",
    ...
    category: "breakfast",
    items: [
      { id: "breakfast-whey", foodId: "food-whey", label: "Whey", quantityLabel: "55 g", macros: macros(38.5, 10.8, 3.5, 0, 89, 229.2), kind: "food" },
      { id: "breakfast-creatina", foodId: "food-creatina", label: "Creatina", quantityLabel: "10 g", macros: macros(0, 0, 0, 0, 0, 0), kind: "supplement" },
      { id: "breakfast-psyllium", foodId: "food-psyllium", label: "Psyllium", quantityLabel: "5 g", macros: macros(0, 0.55, 0.1, 4.05, 0, 9), kind: "supplement" },
      { id: "breakfast-multi", foodId: "supp-multivitaminico", label: "Multivitaminico", quantityLabel: "1 caps", macros: macros(0, 0, 0, 0, 0, 0), kind: "supplement" },
      { id: "breakfast-beta", label: "Beta-alanina", quantityLabel: "3 g", macros: macros(0, 0, 0, 0, 0, 0), kind: "supplement" },
      { id: "breakfast-ala", label: "Acido alfa lipoico 300mg", quantityLabel: "1 caps", macros: macros(0, 0, 0, 0, 0, 0), kind: "supplement" },
      { id: "breakfast-vitc", label: "Vitamina C 1g", quantityLabel: "1 caps", macros: macros(0, 0, 0, 0, 0, 0), kind: "supplement" },
      { id: "breakfast-ltyr", label: "L-Tirosina 500mg", quantityLabel: "1 caps", macros: macros(0, 0, 0, 0, 0, 0), kind: "supplement" },
    ],
  },
  {
    id: "meal-lunch",
    ...
    category: "lunch",
    items: [
      { id: "lunch-protein", foodId: "food-protein-base", label: "Proteína", quantityLabel: "200 g acem / 170 g atum", macros: macros(39.6, 0, 11, 0, 99, 256), kind: "food", notes: "Escolha uma das fontes." },
      { id: "lunch-carb", foodId: "food-carb-base", label: "Carbo", quantityLabel: "160 g high / 80 g low", macros: macros(6.6, 62, 0.6, 0, 535, 287), kind: "food" },
      { id: "lunch-ketchup", foodId: "food-ketchup", label: "Ketchup", quantityLabel: "100 g", macros: macros(0, 25, 0, 0, 665, 99), kind: "food" },
  ...
  },
  {
    ...
    category: "dinner",
    items: [
      { id: "dinner-protein", foodId: "food-protein-base", label: "Proteína", quantityLabel: "200 g acem / 170 g atum", macros: macros(39.6, 0, 11, 0, 99, 256), kind: "food", notes: "Escolha uma das fontes." },
      { id: "dinner-carb", foodId: "food-carb-base", label: "Carbo", quantityLabel: "160 g high / 80 g low", macros: macros(6.6, 62, 0.6, 0, 535, 287), kind: "food" },
      { id: "dinner-ketchup", foodId: "food-ketchup", label: "Ketchup", quantityLabel: "100 g", macros: macros(0, 25, 0, 0, 665, 99), kind: "food" },
...
export const dailyNutritionTargetsSeed: DailyNutritionTargets = {
  ...
  sodiumTargetMg: 3000,
  totals: macros(151.2, 294, 50.4, 17.9, 3000, 1789),
  perKg: {
    waterMl: 50,
    protein: 1.8,
    carbs: 3.5,
